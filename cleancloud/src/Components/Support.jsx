...
const Support =() =>{
    ...
    return(
        <Box pt={20}  sx={{ position: "relative", backgroundColor: "background.other", display:"flex", height: "400px",alignSelf: "center",
        ...
        <>
            ...
            />
             ...
             flexDirection: "column", gap: "20px", alignItems: isTablet ? "center":"left"}}>
                ...
                <Button sx={{textTransform: "none", color:"text.secondary", backgroundColor: "text.otherSecondary", width:"30%",
                borderRadius: "20px"}}>
                    Contact Us
                </Button>
            </Box>
